...
/**
 * THIS CLASS IS GIVEN TO YOU. DO NOT CHANGE. YOU SHOULD GENERALLY UNDERSTAND
 * HOW IT WORKS, BUT UNDERSTANDING SPECIFICS IS NOT REQUIRED.
 *
 * Lab 7
 *
 * Class to compare the behavior of different hospitals (stack, queue, priority
 * queue) treating different types of patients (animal, person).
 *
 * @author Stephen
 * @version 2019-03-06
 */
...
{
    /**
     * Main method for the Hospital Comparison system. Takes repeated inputs from
     * the user to interact with the hospitals. Three hospitals are created for
     * treating animals and people each. When a person or animal is added, it is
     * added to all three associated hospitals (stack, queue, and priority queue).
     * This allows the user to compare how the hospitals determine the order of
                    ...
                    case "add":
                        ...
                        } else if (choice.equalsIgnoreCase("person"))
                        {
                            ...
                            if (choice2.equalsIgnoreCase("sick"))
                            {
                                ...
                                {
                                    hos.addPatient(new SickPerson(info[0], Integer.parseInt(info[1]),
