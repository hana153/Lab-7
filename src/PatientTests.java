...
public class PatientTests
{
    ...
    public void StackHospitalTest()
    {
        ...
        Assert.assertEquals("StackHospital allPatentInfo incorrect.", hPerson1.toString() + hPerson2.toString(), stHos.allPatientInfo());
    }
    /**
    ...
    public void QueueHospitlTest()
    {
        ...
        Assert.assertEquals("QueueHospital allPatientInfo incorrect.", hPerson2.toString() + sPerson1.toString(), quHos.allPatientInfo());
    ...
    public void PriorityQueueHospitlTest()
    {
        ...
        Assert.assertEquals("PriorityQueueHospital HospitalType incorrect.", "PriorityQueueHospital", prHos.hospitalType());
        Assert.assertEquals("PriorityQueueHospital allPatientInfo incorrect.", sPerson1.toString() + hPerson2.toString(), prHos.allPatientInfo());
    }
}
