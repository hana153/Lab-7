/**
 * Class representing a Hospital. Hospitals store a collection of patients who
 * are waiting to receive medical treatment. Patients are treated one at a time
 * by some defined ordering. How to determine which patient to treat next is the
 * responsibility of the Hospital subclasses. Once a patient is treated, it is
 * removed from the Hospital.
 *
 * Hospitals may have different types of patients. In the case of this lab, the
 * two general patient types used are Person and Animal.
 *
 * @author Stephen
 * @version 2019-03-07
 * @param <PatientType> The generic type for the type of patient that the
 *        Hospital accepts.
 */
public abstract class Hospital<PatientType>
{
     ...
     * patient (i.e. it is not removed from the collection of patients that the
     ...
     * healed they no longer need to stay in the Hospital.
     *
     ...
     *
     * @return The toString of all patients, concatenated (don't add spaces,
     *         newlines, etc...).
     */
     ...
     *
     * @return The string "A %s-type hospital with %d patients.", with replacements
     *         of the hospitalType and the number of patients.
     */
    @Override
