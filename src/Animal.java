...
public class Animal implements Comparable<Animal>
{
     ...
     *
     * @return The string "A %d-year old %s." with replacements of the animal's age
     *         and breed.
     */
    @Override
     ...
     * @return The following values: (1) self's age is lower than o's age: positive
     *         value (2) self's age is greater than o's age: negative value (3) ages
     *         are equal: 0
     */
    @Override
